...
const logoButtons = [
  { href: "/zibert",       label: "Žibert",  bg: "bg-[#FFE76E]", src: "/slike/logo/logo-zibert.png" },
  { href: "/drive-in",     label: "Drive-in",bg: "bg-[#FFA178]", src: "/slike/logo/logo-drive-in.png" },
  { href: "/rooms",        label: "Rooms",   bg: "bg-[#D8BDA7]", src: "/slike/logo/logo-rooms.png" },
  { href: "/dogodki",      label: "Dogodki",bg:"bg-[#FFB6B6]", src: "/slike/logo/logo-dogodki.png" },
  { href: "https://wolt.com/sl/svn/ljubljana/restaurant/park-zibert", 
                         label: "Wolt",    bg: "bg-[#99E5FF]", src: "/slike/logo/logo-wolt.png" },
];
